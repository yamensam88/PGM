...
import { Sparkles, Printer, TrendingDown, TrendingUp, AlertTriangle, Target, MapPin, UserRound, PauseCircle, PackageX } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      {data.actions.length > 0 && (
        <div className="rounded-xl border border-indigo-200 bg-indigo-50/40 p-4">
          ...
          <p className="mt-2 text-[10px] text-slate-400">Impacts estimés à partir de vos données réelles de la période — ordres de grandeur d'aide à la décision, non un engagement comptable.</p>
        </div>
      )}
    </div>
  );
